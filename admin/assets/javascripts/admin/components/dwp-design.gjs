  ...
  <template>
    <DwpPageLayout @titleLabel="dwp.admin.design_title" @descriptionLabel="dwp.admin.design_description">
      ...
      <:content>
        ...
        <DwpAccordion @title="Logo" @open={{true}} @icon="image">
        ...
        <DwpAccordion @title="Typography" @icon="font" @locked={{this.controller.isLocked}}>
        ...
        <DwpAccordion @title="Animations & Effects" @icon="sparkle" @locked={{this.controller.isLocked}}>
        ...
        <DwpAccordion @title="Preloader" @icon="spinner" @locked={{this.controller.isLocked}}>
