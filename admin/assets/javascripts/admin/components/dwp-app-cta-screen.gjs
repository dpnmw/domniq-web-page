...
export default class DwpAppCtaScreen extends Component {
  ...
  <template>
    ...
    <DwpAccordion @title="Text Colours" @icon="palette" @locked={{this.c.isLocked}}>
    ...
    <DwpAccordion @title="App Badges" @icon="mobile" @locked={{this.c.isLocked}}>
    ...
    <DwpAccordion @title="Promotional Image" @icon="image" @locked={{this.c.isLocked}}>
      <DwpUploadNote @fieldName="cta_image" />
    </DwpAccordion>

    <DwpAccordion @title="Gradient Background" @icon="drip" @locked={{this.c.isLocked}}>
